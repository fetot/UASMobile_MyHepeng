...
class Income extends React.Component {
  ...
  postIncome() {
        ...
        var saldo_new = saldo_old + nominal //menambah saldo awal dengan nominal pendapatan baru
        var data = {
        ...
        .then(() => {
            ...
            .then(() => {
                console.log('Pendapatan berhasil ditambah.')
  ...
  render() {
    ...
    <View style={styles.contInput}>
      <View style={styles.contInputInner}>
        ...
        />
        <TextInput
        style={styles.inputNominalIncome}
        placeholder='0'
